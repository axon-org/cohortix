...
export const rhythmStatusEnum = pgEnum('rhythm_status', ['active', 'paused', 'completed', 'archived']);
export const rhythmFrequencyEnum = pgEnum('rhythm_frequency', ['daily', 'weekly', 'biweekly', 'monthly', 'quarterly', 'custom']);
