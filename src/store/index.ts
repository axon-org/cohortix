...
// Billing/provisioning entity that can own multiple Cohortix workspaces.
...
interface MissionControlStore {
  ...
  // Cohortix Phase 2 - Activities
  activities: Activity[]
  setActivities: (activities: Activity[]) => void
  addActivity: (activity: Activity) => void

  // Cohortix Phase 2 - Notifications
