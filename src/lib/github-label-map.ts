/**
 * Bidirectional mapping between Cohortix statuses/priorities and GitHub labels.
...
const STATUS_LABEL_MAP: Record<TaskStatus, LabelDef> = {
  inbox:          { name: 'mc:inbox',          color: '6b7280', description: 'Cohortix: inbox' },
  assigned:       { name: 'mc:assigned',       color: '3b82f6', description: 'Cohortix: assigned' },
  in_progress:    { name: 'mc:in-progress',    color: 'eab308', description: 'Cohortix: in progress' },
  review:         { name: 'mc:review',         color: 'a855f7', description: 'Cohortix: review' },
  quality_review: { name: 'mc:quality-review', color: '6366f1', description: 'Cohortix: quality review' },
  done:           { name: 'mc:done',           color: '22c55e', description: 'Cohortix: done' },
}
