...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Success - redirect to check email page or directly to dashboard
      router.push('/');
      router.refresh();
    } catch (err: any) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          <h2 className="text-xl font-semibold mb-6" style={{ color: '#F2F2F2' }}>
            Create your account
          </h2>
          ...
          <div className="flex items-center gap-3 my-6">
            <div className="flex-1 h-px" style={{ backgroundColor: '#27282D' }} />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="h-11 rounded-lg font-medium transition-all flex items-center justify-center gap-2"
              style={{
                backgroundColor: '#0A0A0B',
                border: '1px solid #27282D',
                color: '#D1D5DB',
