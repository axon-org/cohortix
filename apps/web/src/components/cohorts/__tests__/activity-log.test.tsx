...
describe('ActivityLog', () => {
  ...
  it('applies correct color for joined_cohort action', () => {
    const { container } = render(<ActivityLog activities={[mockActivities[0]!]} />);
  ...
  it('applies correct color for engagement_spike action', () => {
    const { container } = render(<ActivityLog activities={[mockActivities[1]!]} />);
  ...
  it('applies correct color for engagement_drop action', () => {
    const { container } = render(<ActivityLog activities={[mockActivities[2]!]} />);
  ...
  it('applies correct color for left_cohort action', () => {
    const { container } = render(<ActivityLog activities={[mockActivities[3]!]} />);
  ...
  it('applies default color for unknown actions', () => {
    const { container } = render(<ActivityLog activities={[mockActivities[5]!]} />);
