  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 space-y-6 text-center">
      <div className="relative transform transition-all duration-700 ease-out scale-100">
        <div className={`bg-green-100 p-4 rounded-full transition-all duration-500 ${showTick ? 'scale-110 opacity-100' : 'scale-50 opacity-0'}`}>
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground max-w-sm mx-auto">
          Your Cohort is now powered by your OpenClaw Engine.
          You can now assign tasks to your agents and they will execute on your local machine.
        </p>
      </div>
