...
> This README defines the folder hierarchy for all project documentation. Every
> file should live in its proper folder — no loose files at the root.
