...
Complete CRUD (Create, Read, Update, Delete) operations for cohorts. Users can create cohorts with name, description, and criteria; view cohort details; edit cohort properties; and soft-delete cohorts with 30-day recovery window.
...
- [ ] Test keyboard navigation: Tab through form, Enter to submit, Escape to close dialog
...
**Local Development:**
- [ ] Install test dependencies: `pnpm add -D vitest @testing-library/react playwright`
...
*This test plan follows the Axon Codex v1.2 Testing Standards (§4).*
