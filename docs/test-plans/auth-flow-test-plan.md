...
Complete authentication flow including sign-up, sign-in, password reset, and session management using Supabase Auth. Supports email/password authentication with optional MFA (TOTP).
