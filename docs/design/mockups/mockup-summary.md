...
- **Screenshot:** https://api.v0.dev/v1/chats/m4idTPxj8rS/versions/b_C0LodAJDGfM/screenshot
...
- **Screenshot:** https://api.v0.dev/v1/chats/dVjHZ3hebPP/versions/b_gPgfq8RYXUR/screenshot
...
- **Screenshot:** https://api.v0.dev/v1/chats/oih2C6SMaCS/versions/b_mgplWTzbAWR/screenshot
...
- Primary: `hsl(248, 50%, 52%)` — warm indigo
- Text: `hsl(30, 10%, 15%)` — warm near-black
- Border: `hsl(40, 20%, 88%)`
- Status: green-500 (idle), yellow-500 (busy), red-500 (error), gray-400 (offline)

---

## Review Checklist
- [ ] Ahmad reviews all 3 demo URLs
- [ ] Brand colors correct (indigo primary, warm paper bg)
- [ ] Typography legible at mobile breakpoints
