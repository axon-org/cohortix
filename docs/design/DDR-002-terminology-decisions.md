...
Cohortix uses **mission-based, human-friendly terminology** instead of generic technical jargon. Core terms: **Allies** (not agents), **Missions** (not actions/tasks), **Cohorts** (not teams/groups), and **Mission Control** (not dashboard).
...
**Boundary:**  
We avoid *over-militarizing*. No "commanders", "squads", "operations" — those feel aggressive. "Mission" + "ally" strikes the balance.
...
- **Educational roots** — Cohorts are groups united by shared experience (positive connotation)
...
2. **Respect user language** — If they say "task", gently rephrase to "mission" in responses
...
2. **Instant recognition** — New users must learn "ally = AI agent"
   - *Mitigation:* First-time user tooltips explain terminology
...
3. **Narrative coherence** — Mission-based language creates story, not transactions
...
- ✅ **Brand guidelines:** `docs/BRAND_GUIDELINES.md` — Terminology table complete
- ✅ **UI components:** All shadcn components use correct terms
- ✅ **Database schema:** Internal naming (allies, missions, cohorts) aligned with UI
...
1. **Client terminology** — Should we call organizations "clients" or "workspaces"?
   - *Current:* Using "HQ" (headquarters) but may cause confusion for B2B SaaS
2. **Knowledge base** — "Intel" is thematic but may be unclear
   - *Alternative:* "Learnings", "Knowledge", "Insights"
...
- [User Research Notes](../research/terminology-study-jan-2026.md) — (to be created)
