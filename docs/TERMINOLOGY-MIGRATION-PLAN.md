...
Migrate all Cohortix documentation, source code, database schema, UI copy, and agent knowledge to the approved PPV Pro-aligned terminology. Both humans and agents use the same vocabulary.
...
**⚠️ BREAKING:** "Mission" shifted from atomic task → measurable outcome. "Task" is now atomic.
...
**Phase 3 must complete before Phase 4** (code changes inform DB migration needs).
**Phase 5 can run in parallel with Phase 4.**
**Phase 6 is the final gate — nothing ships without it.**
...
*Last updated: 2026-02-12 19:30 PKT*
