...
const connectionString = process.env.DATABASE_URL || 'postgresql://postgres.rfwscvklcokzuofyzqwx:<DB_PASSWORD>@aws-0-us-east-1.pooler.supabase.com:6543/postgres?sslmode=require';
