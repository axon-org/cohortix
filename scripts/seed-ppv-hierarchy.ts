...
async function main() {
  ...
  const missionsData = [
    ...
    },
    {
      ...
      description:
        'Onboard 100 active beta users and gather feedback for product-market fit validation.',
      status: 'active',
    ...
    },
    {
      ...
      description:
        'Achieve 99.9% uptime, sub-500ms API response times, and comprehensive monitoring.',
      status: 'active',
  ...
  const operationsData = [
    {
      ...
      description:
        'Separate Missions, Operations, and Tasks into distinct tables with proper relationships.',
      status: 'active',
  ...
  console.log(
    `  🚀 Operations: ${operations.length} new + ${existingOperations?.length || 0} linked`
  );
